...
The implementation is currently working for formulas like (instead of ≤ there can be < or =, instead of <img src="https://render.githubusercontent.com/render/math?math=\exists">there can be <img src="https://render.githubusercontent.com/render/math?math=\forall">)
